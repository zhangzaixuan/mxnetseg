# coding=utf-8
# https://github.com/dmlc/gluon-cv/blob/master/gluoncv/data/mscoco/segmentation.py
...
class MSCOCO(SegmentationDataset):
    """
    ...
    def __init__(self, root=None,split='train', mode=None, transform=None, **kwargs):
        root = root if root is not None else os.path.join(dataset_dir(), 'COCO')
